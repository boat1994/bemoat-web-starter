...
| Harness scripts | `scripts/sync-boilerplate.ts`, `scripts/check-boilerplate-drift.ts`, `scripts/deploy-smoke-test.ts`, `scripts/guard-*.ts`, `scripts/guards/*.ts`, `scripts/install-git-hooks.ts` |
