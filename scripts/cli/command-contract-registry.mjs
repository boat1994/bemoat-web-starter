...
const commands = {
  ...
  'bemoat:mission-control:recover-state': contract({
    ...
    required_evidence: [
      ...
      'One immutable Founder adoption authorization, implementation RESULT, reviewed eligibility verdict, and recovery authorization bind the same Task/PR/base/head.',
    ...
    stop_conditions: [
      'Stop on any valid existing state, malformed or partial marker block, ambiguous history, conflicting counters, competing authority, supersession, unsupported lineage, or executed adoption evidence.',
