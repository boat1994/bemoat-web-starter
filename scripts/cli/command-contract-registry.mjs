...
import { missionControlPrimaryRoutes } from './mission-control-routing-policy-primary.mjs'
import { missionControlRecoveryRoutes } from './mission-control-routing-policy-recovery.mjs'
...
const missionControlDependencies = { contract, positional, stdinInput, flag, environment, nextAction }
