...
const commands = {
  ...
  'bemoat:mission-control:recover-state': contract({
    ...
    required_evidence: [
      ...
      'One immutable Founder adoption authorization, historical implementation RESULT/review, original recovery authorization, current recovery RESULT/review, and lineage-correction authorization bind the same Task/PR/base/branch lineage.',
      'The historical adopt-finding implementation/review head is proven by trusted repository ancestry to be an ancestor of the current recovery head.',
    ...
    reads: [
      ...
      'trusted repository Git ancestry between historical and current heads',
      'trusted Founder identity configuration',
