...
export { classifyReviewVerdictBindingEvidence, isExplicitlyNonAuthoritativeRoleBody, normalizeAuthorityBase, normalizeAuthorityHead, parseRoleCommentBody, selectActiveRoleComments, selectLiveReviewVerdictComment } from './mission-control/review-verdict-binding.mjs'
...
export { buildCorrectionHandoffBinding } from './mission-control/founder-correction-dispatch.mjs'
