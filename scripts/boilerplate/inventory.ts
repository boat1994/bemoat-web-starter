...
export const managedPaths = [
  ...
  'tests/int/context-parser.int.spec.ts', 'tests/int/context-router.int.spec.ts', 'tests/int/context-evidence.int.spec.ts', 'tests/int/approved-base.int.spec.ts', 'tests/int/context-cli.int.spec.ts', 'tests/int/context-skill.int.spec.ts', 'tests/int/context-sync.int.spec.ts', 'tests/int/context-corrections.int.spec.ts', 'tests/int/issue-branch-bootstrap.int.spec.ts',
  ...
  'tests/int/mission-control-delegation-policy.int.spec.ts',
