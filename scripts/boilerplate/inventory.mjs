...
export const managedPaths = [
  ...
  'scripts/mission-control', 'scripts/mission-control/domain/task-state.mjs', 'scripts/mission-control/diagnostics/github-comment-projection.mjs',
  ...
  'tests/int/scripts-architecture.int.spec.ts', 'tests/int/campaign-schema.int.spec.ts', 'tests/int/campaign-normalize.int.spec.ts',
  'tests/int/scripts-entrypoints-contract.int.spec.ts', 'tests/int/mission-control-review.int.spec.ts',
  'tests/int/mission-control-merge.int.spec.ts', 'tests/int/mission-control-merge-github-adapter.int.spec.ts', 'tests/int/merge-cli-args.int.spec.ts', 'tests/int/mission-control-merge-campaign-expansion-authority.int.spec.ts', 'tests/int/mission-control-merge-campaign-projection.int.spec.ts', 'tests/int/mission-control-merge-direct-ownership.int.spec.ts', 'tests/int/mission-control-merge-mergeability.int.spec.ts', 'tests/int/mission-control-merge-commit-messages.int.spec.ts', 'tests/int/mission-control-merge-gh-pages.int.spec.ts', 'tests/int/mission-control-merge-next-action.int.spec.ts', 'tests/int/mission-control-merge-verdict-binding-entrypoint.int.spec.ts', 'tests/int/mission-control-merge-safe-execution-bundle.int.spec.ts', 'tests/int/mission-control-merge-comment-supersession.int.spec.ts', 'tests/int/mission-control-merge-terminal-binding.int.spec.ts', 'tests/int/mission-control-merge-state-block-replacement.int.spec.ts', 'tests/int/mission-control-merge-cli-result-rendering.int.spec.ts', 'tests/int/mission-control-issue-body-cas.int.spec.ts',
