...
export const managedPaths = [
  ...
  'tests/int/mission-control-recover-state.int.spec.ts', 'tests/int/mission-control-recover-state-evidence.int.spec.ts',
...
export const managedPackageScripts = [
  ...
  'bemoat:mission-control:adopt-finding', 'bemoat:mission-control:recover-state', 'bemoat:mission-control:authorize-founder',
