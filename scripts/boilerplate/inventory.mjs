...
export const managedPaths = [
  ...
  'tests/int/mission-control-merge.int.spec.ts', 'tests/int/mission-control-merge-mergeability.int.spec.ts', 'tests/int/mission-control-merge-commit-messages.int.spec.ts', 'tests/int/mission-control-merge-next-action.int.spec.ts', 'tests/int/mission-control-merge-verdict-binding-entrypoint.int.spec.ts', 'tests/int/mission-control-issue-body-cas.int.spec.ts',
