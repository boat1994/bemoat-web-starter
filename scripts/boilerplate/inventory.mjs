...
export const managedPaths = [
  ...
  'tests/int/mission-control-characterization.int.spec.ts', 'tests/int/mission-control-task-bootstrap-contract.int.spec.ts', 'tests/int/mission-control-task-bootstrap-allocation.int.spec.ts', 'tests/int/mission-control-task-bootstrap-state.int.spec.ts', 'tests/int/mission-control-task-initialization.int.spec.ts',
