...
export const managedPaths = [
  ...
  'scripts/agent-issue', 'scripts/agent-context.mjs', 'scripts/agent-context-sync-base.mjs', 'scripts/context', 'scripts/agent-handoff.mjs', 'scripts/handoff', 'scripts/agent-delivery.mjs',
  ...
  'scripts/cli',
  'scripts/guard-cloudflare-env.mjs', 'scripts/guards/cloudflare-env.mjs', 'scripts/guard-pack.mjs', 'scripts/guards/pack.mjs', 'scripts/guards/planning-contract-runtime.mjs',
  'scripts/guards/planning-contract.mjs',
  'scripts/guards/structural-protection.mjs', 'scripts/structural-protection-manifest.json',
  'scripts/guards/mission-control-drift.mjs',
  'scripts/guards/scripts-architecture.mjs',
  'scripts/architecture-contract.json', 'scripts/AGENTS.md', 'scripts/ARCHITECTURE.md',
  'scripts/mission-control', 'scripts/mission-control/domain/task-state.ts', 'scripts/mission-control/diagnostics/github-comment-projection.mjs',
  ...
  'tests/int/context-parser.int.spec.ts', 'tests/int/context-router.int.spec.ts', 'tests/int/context-evidence.int.spec.ts', 'tests/int/context-cli.int.spec.ts', 'tests/int/context-sync.int.spec.ts', 'tests/int/context-corrections.int.spec.ts',
  ...
  'tests/int/agent-issue/issue-declarations.int.spec.ts',
  'tests/int/agent-issue/current-post-budget-authority.int.spec.ts',
  'tests/int/agent-issue/historical-review3-authority.int.spec.ts',
  ...
  'tests/int/transport-registry-batch8.int.spec.ts',
  ...
  'tests/int/mission-control-merge.int.spec.ts', 'tests/int/mission-control-merge-authorization-recording.int.spec.ts', 'tests/int/mission-control-merge-github-adapter.int.spec.ts', 'tests/int/mission-control-merge-head-bindings.int.spec.ts', 'tests/int/mission-control-merge-live-protected-base.int.spec.ts', 'tests/int/merge-cli-args.int.spec.ts', 'tests/int/mission-control-merge-campaign-expansion-authority.int.spec.ts', 'tests/int/mission-control-merge-campaign-projection.int.spec.ts', 'tests/int/mission-control-merge-direct-ownership.int.spec.ts', 'tests/int/mission-control-merge-mergeability.int.spec.ts', 'tests/int/mission-control-merge-commit-messages.int.spec.ts', 'tests/int/mission-control-merge-gh-pages.int.spec.ts', 'tests/int/mission-control-merge-next-action.int.spec.ts', 'tests/int/mission-control-merge-verdict-binding-entrypoint.int.spec.ts', 'tests/int/mission-control-merge-safe-execution-bundle.int.spec.ts', 'tests/int/mission-control-merge-comment-supersession.int.spec.ts', 'tests/int/mission-control-merge-terminal-binding.int.spec.ts', 'tests/int/mission-control-merge-state-block-replacement.int.spec.ts', 'tests/int/mission-control-merge-cli-result-rendering.int.spec.ts', 'tests/int/mission-control-issue-body-cas.int.spec.ts',
