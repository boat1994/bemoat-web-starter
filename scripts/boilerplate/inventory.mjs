...
export const managedPaths = [
  ...
  'tests/int/mission-control-recover-review.int.spec.ts', 'tests/int/mission-control-recover-review-github-adapter.int.spec.ts', 'tests/int/mission-control-recover-review-malformed-findings.int.spec.ts',
