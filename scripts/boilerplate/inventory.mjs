...
export const managedPaths = [
  ...
  'tests/int/mission-control-merge.int.spec.ts', 'tests/int/mission-control-merge-campaign-projection.int.spec.ts', 'tests/int/mission-control-merge-direct-ownership.int.spec.ts', 'tests/int/mission-control-merge-mergeability.int.spec.ts', 'tests/int/mission-control-merge-commit-messages.int.spec.ts', 'tests/int/mission-control-merge-gh-pages.int.spec.ts', 'tests/int/mission-control-merge-next-action.int.spec.ts', 'tests/int/mission-control-merge-verdict-binding-entrypoint.int.spec.ts', 'tests/int/mission-control-merge-safe-execution-bundle.int.spec.ts', 'tests/int/mission-control-merge-comment-supersession.int.spec.ts', 'tests/int/mission-control-merge-terminal-binding.int.spec.ts', 'tests/int/mission-control-merge-state-block-replacement.int.spec.ts', 'tests/int/mission-control-issue-body-cas.int.spec.ts',
