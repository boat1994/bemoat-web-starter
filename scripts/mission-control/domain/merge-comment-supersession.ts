import { parseFounderMergeAuthorization } from './merge-founder-authority.ts'

export function commentSupersedesId(body: unknown, targetCommentId: string | number): boolean {
