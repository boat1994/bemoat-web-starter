...
const taskPayloadSchema = z.looseObject({ attestation_schema: optionalString, operation: optionalString, operation_version: optionalNumber, managed_state_sha256: optionalString, repository: optionalString, repository_id: optionalIdentityValue, repository_node_id: optionalIdentityValue, protected_base_sha: optionalString, founder_login: optionalString, authorization_comment_id: optionalIdentityValue, authorization_body_sha256: optionalString, parent_issue_number: optionalIdentityValue, parent_issue_id: optionalIdentityValue, parent_issue_node_id: optionalIdentityValue, task_issue_number: optionalIdentityValue, task_issue_id: optionalIdentityValue, task_issue_node_id: optionalIdentityValue, pr_number: optionalIdentityValue, pr_id: optionalIdentityValue, pr_node_id: optionalIdentityValue, base: optionalString, head: optionalString, workflow_mode: optionalString, policy_path: optionalString, policy_version: z.union([z.string(), z.number()]).nullable().optional(), policy_source_commit: optionalString, policy_blob_sha: optionalString, request_id: optionalString, workflow_file: optionalString, workflow_ref: optionalString, workflow_sha: optionalString, workflow_run_id: optionalIdentityValue, signing_key_id: optionalString })
