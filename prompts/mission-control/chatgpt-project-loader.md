...
Compact bundle prompts must name the repository and active Issue/PR, authority
reference, exact head/base, bounded objective, required evidence, stop
conditions, and prohibited actions. Do not bundle across implementation, review,
and merge gates.
