  ...
  const deps: Record<string, any> = {
    ...
    readReviewVerdict: async (_repo: string, _issueNumber: number, commentId: string) => {
      ...
      return {
        ...
        base: options.reviewedVerdictBase ?? 'main',
        pr: String(prNumber),
        repository: options.reviewedVerdictRepository ?? _repo,
        issue: options.reviewedVerdictIssue ?? String(_issueNumber),
        non_superseded: options.reviewVerdictSuperseded === true ? false : true,
      }
    },
