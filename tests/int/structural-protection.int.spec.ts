...
const oracle = [
  ...
  ['tests/int/mission-control-merge-verdict-binding-entrypoint.int.spec.ts', 'fca0c2a99119861b5a6b4bdd428616b65e4d0a248080ddd39de50fa24e9fa363'],
...
const grandfathered = [
  ...
  ['scripts/mission-control/domain/recover-state-lineage.ts', 485],
...
describe('structural protection guard', () => {
  it('accepts the current repository with the exact inventory, baseline, and protected oracle', async () => {
    ...
    expect(scriptInventory(root)).toBe(259)
  })
