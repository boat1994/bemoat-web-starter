...
const EXPECTED_PACKAGE_SCRIPTS: Record<string, string> = {
  ...
  'bemoat:mission-control:rebind-review-lineage': 'node scripts/mission-control-rebind-review-lineage.mjs',
...
const EXPECTED_COMMAND_TIERS: Record<string, 'A' | 'B' | 'C'> = {
  ...
  'bemoat:mission-control:rebind-review-lineage': 'A',
...
describe('Task 1 command contract registry', () => {
  ...
  it('uses tier totals A=14 B=8 C=3', () => {
